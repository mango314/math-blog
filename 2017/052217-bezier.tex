...
\noindent \#\textbf{ 4} I never consdered that the square-billiard could be connected to Ratner Theory and the Oppenheim conjecture.  I kind of get the feeling and then I lose it and then I get it again when I look at the pictures in certain textbooks. \\ \\
The main event here is the Oppenheim conjecture and it's solution via Ratner Theorem.  This is a badly chaotic regime and ideas of sorting it out are still being figured out. \\ \\
Item \#2 on nodal curves (and the surfaces of the vibrating drum) will be written hopefully soon.  And space-filling curves!  I think they're really cool.
