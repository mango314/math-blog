...
\end{tikzpicture}  \\ \\
This is a quick drawing.  The natural question: how does a circle cut these shapes? Since I have written: $ \eta(z)^2 \eta(11z)^2 $ is the weight-2 modular form, let $q = e^{2\pi i \, z}$ and check:
$$ S_2^{new}(11) = \eta(z)^2 \, \eta(11z)^2 \, dz = q \prod_{n=1}^\infty \big( 1 - q^n \big)^2 \big( 1 - q^{11n} \big)^2 \text{ is invariant under } \Big\langle z \mapsto z + \frac{1}{11}, z \mapsto - \frac{1}{z} \Big\rangle $$
...
There also seems to be approach using modular symbols.\footnote{\texttt{http://wstein.org/books/modform/modform/weight\_two.html}} that algorithm returns:
$$ \mathbb{M}_2 \big( \Gamma_0(11); \mathbb{Q}\big) = \Big\langle \big\{\infty, 0 \big\}, \big\{ - \frac{1}{8}, 0 \big\} , \big\{ - \frac{1}{9} , 0 \big\} \Big\rangle$$

\begin{tikzpicture}

\draw[line width = 2, color=red!60!white] (0,2)--(0,0);
\draw[line width = 2, color=green!60!white] (-20/9,0) arc (0  :-180:-20/18);
\draw[line width = 2, color=blue!60!white] (-20/8,0) arc (0  :-180:-20/16);

\node at (0 , -0.35) {$\text{0}$};
\node at (-20/8 - 0.3, -0.35) {$-\frac{\text{1}}{\text{8}}$};
\node at (-20/9 + 0.1, -0.35) {$-\frac{\text{1}}{\text{9}}$};

\draw[line width = 2] (-4,0)--(2,0);
...
\draw[color=black!20!white] (1,0) arc (0:90:1);
\draw[color=black!20!white] (10,0) arc (180:90:1);



\draw[line width = 2] (-0.5,0)--(11.5,0);
