...
\textbf{Example: Sum Free Sets} Let $A$ be an additive set of non-zero integers, then $A$ contains a sum-free subset of $B$ of size $|B| > |A|/3$. \\ \\
One possibility for this theorem is in topics of \textbf{communication complexity} e.g. over telephone lines, or wireless communication.  Literally we our phones and laptops and computers reconstruct sound and video over disturbances of thin air.  So we are led to problems in \textbf{Ramsey theory}.  Our very attempts budget our resources in sending messages leads to dilemmas of information compression, such as {\color{green}multi-party communication} and {\color{green}discrepancy theory}.
\vfill
...
\item Stasys Jukna \textbf{Extremal Combinatorics with Applications in Computer Science} (Texts in Theoretical Computer Science) Springer, 2001.
