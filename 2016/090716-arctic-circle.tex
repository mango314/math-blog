...
is the
number of red balls after $t$ transitions. \\ \\ $\{X_t\}_{t \in \mathbb{N}}$ is a reversible {\color{green!50!black}{\textbf{Markov Chain}}}
with a Binomial $(N, \frac{1}{2})$ stationary distribution. \end{quotation}

\newpage

\noindent So this Ehrenfest model can also be considered a random walk on $(\mathbb{Z}_2)^N$. \begin{tikzpicture} 
\draw[color=red!50!white, fill=red!50!white] (0,0) circle (12pt); 
\draw[color=blue!50!white, fill=blue!50!white] (36pt,0) circle (12pt);
\draw[color=blue!50!white, fill=blue!50!white] (72pt,0) circle (12pt);
\draw[color=red!50!white, fill=red!50!white] (108pt,0) circle (12pt); 
\draw[color=red!50!white, fill=red!50!white] (144pt,0) circle (12pt); 
\end{tikzpicture} \\ \\
